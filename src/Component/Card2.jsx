...
function Card2({name,id,price,image,qty }) {
  ...
  return (
    <div className="w-full h-[120px]  p-2 flex justify-between  ">
      <div className="w-[60%] h-full flex gap-5">
        ...
        <div className="w-[40%] h-full flex flex-col gap-3">
          ...
          <div className="w-[110px] h-[50px]  flex rounded-lg overflow-hidden shadow-lg border-2 border-green-400  text-xl ">
            ...
            <span className="w-[40%] h-full  flex justify-center items-center items-center bg-slate-200 text-green-400">{qty}</span>
      ...
      <div className="flex flex-col justify-start items-end gap-[28px]">
<span className="text-xl text-green-400 font-semibold">Rs {price}/-</span>
<RiDeleteBin6Line className="w-[30px] h-[30px] text-red-400 hover:cursor-pointer"  onClick={()=>dispatch(RemoveItem(id))}/>
      </div>
    </div>
  );
}
